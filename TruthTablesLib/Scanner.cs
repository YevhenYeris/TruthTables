    ...
    public class Scanner
    {
        ...
        private PreliminaryScanResult? PreliminaryScan(string input)
        {
            ...
            while (true)
            {
                ...
                if (curr == "$")
                {
                    result.Tokens.Add(new Token(TokenType.Identity, curr, i));
                    return result;
                }
                ...
                else if (IsOperatorStart(input, i))
                {
                    ...
                    result.Tokens.Add(new Token(TokenType.Identity, operatorName, i));
        ...
        {
            return TryReadVariable(input, index) is not null;
        }

        private bool IsOperatorStart(string input, int index)
        {
            return TryReadOperator(input, index) is not null;
        }
